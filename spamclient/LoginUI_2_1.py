...
class RunThread(QtCore.QThread):
    ...
    def run(self):
        ...
        response_result_list = checkAndJudgeOldMail(self.my_serv, self.my_rulelist)
        ...
        while True:
            ...
            if email_list:
                ...
                response_result_list=judgeNewMail(email_list,self.my_rulelist)
                # for i in email_list:
                    # try:
                    #     # win = PopupWin()
                    #     print("win")
    ...
    def clickbtn1(self):
        ...
        if textboxValue1 == '' or textboxValue2 == '':
            ...
            if MessageReturn[0]=='登陆成功！':
                ...
                intensity = temp.getIntensity(self.thread.my_mailadress)
                MainUI.final_intensity_label.setText(intensity)
